...
import 'package:flutter_sanar_proj/PATIENT/Screens/call_services/call_services.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  late Future<AllServices> _servicesFuture;
  @override
  void initState() {
    super.initState();
    _printServiceId();
    // _fetchDoctorsAndNurses = _fetchDoctorsAndNursesInParallel();
    _servicesFuture = ApiService.fetchAllServices();
  }
            ...
            children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomGradiantIconWidget(
                                  icon: _getServiceIcon(service['id']),
                                  iconSize: 36),
              ...
              FutureBuilder<AllServices>(
                ...
                builder: (context, snapshot) {
                  ...
                  final services = snapshot.data!.results!;
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                              ...
                              trailing: CustomGradiantTextWidget(
                                  text:
                                      " ${service.price ?? '0'} ${Constant.currency}",
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold),
                              leading: ClipRRect(
                                borderRadius: BorderRadius.circular(12),
          ...
          return Container(
            ...
            child: ListTile(
                ...
                subtitle: const Text(
                  "No description",
                  style: TextStyle(
                      color: Constant.hintColor, fontWeight: FontWeight.w400),
                ),
                trailing: const Text(
                  " 123${Constant.currency}",
                  style: TextStyle(
                      color: Constant.primaryColor,
                      fontWeight: FontWeight.bold,
                      fontSize: 16),
