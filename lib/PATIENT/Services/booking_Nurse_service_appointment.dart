...
class booking_Nurse_service_appointment extends StatefulWidget {
  const booking_Nurse_service_appointment({super.key});

  @override
  _booking_Nurse_service_appointmentState createState() =>
      _booking_Nurse_service_appointmentState();
}

class _booking_Nurse_service_appointmentState
    extends State<booking_Nurse_service_appointment> {
  ...
  int? nurseId; // To hold the nurse ID
  int? userNurseID; // To hold the nurse ID
  int? serviceIId;
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      ...
      nurseId = prefs.getInt('nurseServiceId'); // Get nurse ID
      userNurseID = prefs.getInt('userServicenurseId'); // Get nurse ID
  ...
  void initState() {
    super.initState();
    _loadUserData(); // Load token, user ID, and nurse ID when the screen initializes
  }
  ...
  Future<void> _fetchAvailableSlots() async {
    if (nurseId != null && selectedDate != null) {
      ...
      final url = Uri.parse(
          'http://67.205.166.136/api/users/$userNurseID/availabilities/?page=1');
  ...
  Future<void> _onBookAppointment() async {
    if (selectedDate != null &&
      ...
      final int nurseId = this.nurseId!;
