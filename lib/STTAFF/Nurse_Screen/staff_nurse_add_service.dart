...
class _Staff_Nurse_AddserviceState extends State<Staff_Nurse_Addservice> {
  ...
  Future<void> postService() async {
    ...
    try {
      ...
      final nurseId = prefs.getInt('specificId');
      ...
      if (token == null ||
        ...
        throw Exception(
            'Missing token, nurseId, categoryId, or subcategoryId in shared preferences');
      }
      ...
      request.fields.addAll({
        ...
        'subcategory':
            selectedSubcategoryId.toString(), // Include subcategory ID
        'nurses': nurseId.toString(),
      });
      ...
      print('Subcategory ID: $selectedSubcategoryId');
