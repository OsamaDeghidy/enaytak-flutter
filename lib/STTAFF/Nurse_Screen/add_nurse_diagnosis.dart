...
class AddNurseDiagnosisScreen extends StatefulWidget {
  final int appointmentId; // Pass the appointment ID

  const AddNurseDiagnosisScreen({Key? key, required this.appointmentId})
      : super(key: key);

  @override
  _AddNurseDiagnosisScreenState createState() =>
      _AddNurseDiagnosisScreenState();
}

class _AddNurseDiagnosisScreenState extends State<AddNurseDiagnosisScreen> {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: json.encode({
          ...
          'nurse': specificId, // Use nurse ID instead of doctor ID
          'medical_record':
